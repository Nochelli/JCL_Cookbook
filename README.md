...
Com base em estudos e experiência prática com Mainframe, reuni neste repositório os principais utilitários IBM como referência para consultas rápidas, para estudo de JCL (Job Control Language) e uso no ambiente z/OS.
