...
Com base em estudos e na minha experiência prática trabalhando no dia a dia com Mainframe z/OS, reuni neste repositório `jcl_cookbook.jcl` os principais utilitários IBM que usei/uso como referência para consultas rápidas, para estudo de JCL (Job Control Language) e uso no ambiente z/OS.
